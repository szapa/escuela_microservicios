...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppListaUsuariosListaUsuariosComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<h3>lista-usuarios works!</h3>\n<ul>\n    <li *ngFor=\"let usu of listaUsu; let i = index\">\n        <label>Datos:</label>\n        {{usu.id + \", \" + usu.nombre + \" - \" + usu.email}}\n        <input type=\"button\" value=\"Modificar registro\" (click)=\"seModifica = true; usuModif=usu\">\n        <input type=\"button\" value=\"Eliminar\" (click)=\"eliminarUsuario(usu.id)\">\n    </li>\n</ul>\n<ul>\n    {{seModifica}}\n    <div *ngIf=\"seModifica\">\n        <input type=\"text\" [(ngModel)]=\"usuModif.id\">\n        <input type=\"text\" [(ngModel)]=\"usuModif.nombre\">\n        <input type=\"text\" [(ngModel)]=\"usuModif.email\">\n        <input type=\"button\" value=\"Modificar registro2\" (click)=\"modificarUsuario(usuModif.id,usuModif)\">\n    </div>\n</ul>";
    /***/
  },
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppRegistroUsuarioRegistroUsuarioComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<input type=\"text\" [(ngModel)]=\"usuario.nombre\" value=\"Nombre por defecto\"/>\n<input type=\"email\" [(ngModel)]=\"usuario.email\" value=\"email@email.com\"/>\n<input type=\"text\" [(ngModel)]=\"usuario.password\" value=\"1234\"/>\n<br>{{ \"Enviar\" + usuario.nombre + \"-\" + usuario.password }}\n<input type=\"button\" value=\"Enviar datos\"(click) =  \"enviarDatos()\"/>\n\n<div *ngIf=\"estaRegistrado\">Ya se ha registrado</div>\n<div *ngIf=\"!estaRegistrado\">Aún no se ha registrado</div>\n\n\n<!-- <p>registro-usuario works!</p>\n{{ variable }}\n{{ variable }}\n\n<input type=\"text\" [(ngModel)]=\"variable\"/>\n\n<input type=\"button\" value=\"Boton\" (click) = \"pulsar()\"/> -->";
    /***/
  },
    ...
    function () {
      ...
      _createClass(AlmacenLocalService, [{
        ...
        value: function leer(nombre) {
          var ususGuardados = window.localStorage.getItem("usuarios");
  ...
  function srcAppListaUsuariosListaUsuariosComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(ListaUsuariosComponent, [{
        ...
        value: function modificarUsuario(indice, usuario) {
          var _this2 = this;

          this.srvUsu.modificarRegistro(indice, usuario).subscribe(function (usuRecibMod) {
            _this2.ngOnInit();
          });
        }
      }, {
        ...
        value: function eliminarUsuario(id) {
          ...
          this.srvUsu.eliminarRegistro(id).subscribe(function () {
      ...
      _createClass(RegistroUsuarioComponent, [{
        ...
        value: function enviarDatos() {
          ...
          this.usuSrv.registro(this.usuario).subscribe(function (usuRecibido) {
            ...
            if (typeof _this4.usuario.id !== undefined) {
              _this4.estaRegistrado = true;
            }
          });
  ...
  function srcAppUsuariosRestServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(UsuariosRestService, [{
        ...
        key: "modificarRegistro",
        value: function modificarRegistro(indice, usuario) {
          return this.clienteHttp.put("".concat(this.url, "/").concat(indice), usuario);
        }
      }]);
